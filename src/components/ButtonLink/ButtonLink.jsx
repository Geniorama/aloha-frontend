...
export default function ButtonLink({size, color, href, target, text}) {
  return (
      <Link href={href} target={target ? target : '_self'} className={`${styles.ButtonLink} ${styles[size]} ${styles[color]}`}>
          <span>{text}</span>
