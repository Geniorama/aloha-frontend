    ...
    <div className={`${styles.CardCategory} ${styles[size]}`}>
        <Link href={"/"} className={`${styles.CardCategory__link} ${styles[link_position]}`}>
            ...
            <span className={styles.CardCategory__link__arrow}>
                ...
                <g clip-path="url(#clip0_396_1127)">
                <path d="M28.332 28.3346L11.6654 11.668" stroke="#222222" stroke-width="3.33333"/>
                <path d="M28.332 13.334L28.332 28.334L13.332 28.334" stroke="#222222" stroke-width="3.33333"/>
                </g>
                <defs>
